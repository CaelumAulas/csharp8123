...
namespace Banco
{
    public partial class Form1 : Form
    {
        ...
        {
            SortedSet<string> nomeDosDevedores = new SortedSet<string>()
            {
                "victor",
                "osni",
                "ana",
            ...
            nomeDosDevedores.Add(nome);

            foreach(string nomeSet in nomeDosDevedores)
            {
                MessageBox.Show(nomeSet);
            }

            MessageBox.Show("Quantidade de elementos: " + nomeDosDevedores.Count);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            ContaCorrente c4 = new ContaCorrente();
            c4.Titular = new Cliente("osni");
            c4.Titular = new Cliente("Osni Santos");
            c4.Numero = 3;

            Dictionary<string, Conta> contas = new Dictionary<string, Conta>();
            contas.Add(conta1.Titular.Nome, conta1);
            contas.Add(conta2.Titular.Nome, conta2);
            ...
            /*HashSet<Conta> contas = new HashSet<Conta>() { conta1, conta2, c3, c4 };
            MessageBox.Show("Quantidade: " + contas.Count);
            MessageBox.Show("Hashcode c3: " + c3.GetHashCode());
            MessageBox.Show("Hashcode c4: " + c4.GetHashCode());
            MessageBox.Show("c3.Equals(c4)? " + c3.Equals(c4));*/
